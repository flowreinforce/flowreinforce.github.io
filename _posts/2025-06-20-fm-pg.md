...
<div style="text-align: center; margin-bottom: 20px;">
  ...
  <!-- <a href="https://github.com/YOUR-REPO-HERE" class="btn btn-lg z-depth-0" role="button" style="text-decoration: none; border: 1px solid #ccc; margin: 0 5px; padding: 10px 20px;">
